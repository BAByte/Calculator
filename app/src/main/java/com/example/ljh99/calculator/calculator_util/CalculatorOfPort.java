...
public class CalculatorOfPort implements Calculator {
    //用来判断上一次输入的字符是不是符号
    ...
    public CalculatorOfPort(TextViewListener textViewlistener) {
    ...
    public void addSign(String sign) {
        ...
        if (expression.length()>0&&addSigner.add(sign)) {
            textViewlistener.addText("\n" + sign + "      ");
            line++;
            len = 0;
